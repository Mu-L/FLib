...
namespace Kamgam.UIPreview
{
    ...
    {
        public static bool CacheBuilt;
        public static bool TypesFound;
        ...
        public static void ReorderPreviews()
        {
            ...
            var allInspectors = (IList)AllInspectorsInfo.GetValue(null);
            foreach (var inspectorWindow in allInspectors)
            {
                var previews = (IList)PreviewsInfo.GetValue(inspectorWindow);
