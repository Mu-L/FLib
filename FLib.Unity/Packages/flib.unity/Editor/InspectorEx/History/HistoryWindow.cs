...
namespace InspectorHistory
{
    ...
    public class HistoryWindow : EditorWindow, IHasCustomMenu
    {
        ...
        {
            var wnd = GetWindow<HistoryWindow>();
        ...
        private void RefreshElements()
        {
            ...
            for (var i = 0; i < elements.Count; i++)
            {
                ...
                if (i < history.Count)
                {
                    ...
                    element.tooltip = AssetDatabase.GetAssetPath(elementObj);
        ...
        {
            var history = HistoryData.instance;
            var index = root.parent.IndexOf(root);
